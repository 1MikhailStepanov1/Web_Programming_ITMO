    ...
    return (
        <div>
            ...
            <svg onClick={handleClickOnArea} ref={svgDots} width="300" height="300" xmlns="http://www.w3.org/2000/svg">
                <rect x="150" y="30" width=" 120" height="120" fillOpacity="0.4" stroke="black"
                      fill="orange"/>

                <polygon points="300,150 295,155 295, 145" fill="black" stroke="black"/>
                <polygon points="150,0 145,5 155,5" fill="black" stroke="black"/>
                <polygon points="150,150 270,150 150,210" fillOpacity="0.4" stroke="black"
                         fill="pink"/>

                <path d="M 90,150 A 60,60 90 0,0 150,210 L 150,150 Z" fillOpacity="0.4" stroke="black"
                      fill="yellow"/>
